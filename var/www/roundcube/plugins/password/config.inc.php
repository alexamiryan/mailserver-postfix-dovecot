...
$config['password_db_dsn'] = 'mysql://mailadmin:dbpassV@localhost/mailserver';
...
$config['password_query'] = "UPDATE users SET password=CONCAT('{SHA256-CRYPT}', ENCRYPT (%p, CONCAT('$5$', SUBSTRING(SHA(RAND()), -16)))) WHERE email=%u;";
